...
### Note: Explore the end-to-end encrypted chat application project [here](https://github.com/RishiBakshii/mern-chat) using Next.js, Prisma, Postgresql, Express, and Socket.io.

**MERN Ecommerce** is a full-stack application designed to transform the online shopping experience. Built with the MERN stack (MongoDB, Express.js, React, Node.js), it leverages Redux Toolkit for efficient state management and Material UI for a sleek, user-friendly interface. This project offers a robust platform for both users and admins, packed with essential features for a seamless experience.
...
```bash
  git clone https://github.com/rushi-adiboina/mern-ecommerce.git
```
...
- **Please Note**: While the demo account provides a convenient way to explore many features, it has some limitations:
    ...
    **What to do?**
    - If you are primarily interested in exploring other functionalities like wishlist, cart, and order history, the demo account is sufficient.
...
- Original project architecture by Rishi Bakshi

## About the Developer
Rushi Kiran Adiboina is a Full Stack Developer with over 6 years of experience designing, developing, and supporting scalable enterprise applications. With a strong background in React.js, Node.js, and Java Spring Boot, Rushi specializes in building robust frontend components and distributed backend services. His expertise spans across cloud deployment with AWS and Azure, CI/CD automation, and performance optimization for high-demand environments.

**Contact Information:**
- Email: rushikiranadiboina@gmail.com
- LinkedIn: https://www.linkedin.com/in/rushi-adiboina/
- GitHub: https://github.com/rushi-adiboina